...
<body>
                ...
                <div class="collapse navbar-collapse nav-collapse">
                    <div class="menu-container">
                        <ul class="navbar-nav navbar-nav-right">
                            ...
                            <li class="nav-item"><a class="nav-item-child nav-item-hover" href="projects.php">Projects</a></li>
    ...
    <!-- <div class="pricing">
                        ...
                        <a href="services.php" class="btn-theme btn-theme-sm btn-default-bg text-uppercase">Choose</a>
                    </div> -->
    <!-- End Pricing -->
    <!-- </div> -->
    <!-- <div class="col-sm-4 sm-margin-b-2"> -->
